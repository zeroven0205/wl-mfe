...
import { Button, Menu, Submenu, Input, MenuItem, MenuItemGroup, Scrollbar, Loading, Message, MessageBox, Form, FormItem, Tabs, TabPane } from "element-ui";
...
export default {
  components: [
    Button, Menu, Submenu, MenuItem, MenuItemGroup, Scrollbar, Input, Form, FormItem, Tabs, TabPane
  ],
  serve: [Loading],
